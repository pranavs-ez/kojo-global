        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {SERVICES.map((s) => (
            <Link
              key={s.href}
              href={s.href}
              className="group flex flex-col justify-between gap-4 p-5 rounded-[2px] border border-[0.3px] border-kj-light/[0.07] bg-kj-slate/[0.12] min-h-[180px] transition-all duration-300 hover:-translate-y-1 hover:shadow-card-hover"
            >
              ...
              <p className="font-mono text-[12px] text-kj-lime/85">
                {s.price}
              </p>
            </Link>
          ))}
